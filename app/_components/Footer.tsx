...
const Footer = () => {
  ...
  <div className="mx-auto max-w-5xl px-4 justify-center text-center flex flex-col items-center py-16 sm:px-6 lg:px-8">
    ...
    <ul className="flex flex-wrap justify-center pt-16 gap-6 md:gap-8 lg:gap-12">
      ...
      <li>
        <a className="text-dark-500 transition hover:text-gray-700/75" href="#"> Careers </a>
      </li>

      <li>
        <a className="text-dark-500 transition hover:text-gray-700/75" href="#"> History </a>
      </li>

      <li>
        <a className="text-dark-500 transition hover:text-gray-700/75" href="#"> Services </a>
      </li>

      <li>
        <a className="text-dark-500 transition hover:text-gray-700/75" href="#"> Projects </a>
      </li>

      <li>
        <a className="text-dark-500 transition hover:text-gray-700/75" href="#"> Blog </a>
      </li>
    </ul>
    ...
    <div className="fText text-sm pt-8 pr-12 text-blue-950">Copyright © 2024 gokhaneraslan.</div>
  </div>
